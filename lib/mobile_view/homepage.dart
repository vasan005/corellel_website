...
import 'package:corllel/Common_Screens/footermobile.dart';
                ...
                children: <Widget>[
                  ScrollLoopAutoScroll(
                    ...
                    child: Row(children: <Widget>[
                      ...
                      Image.asset('assets/images/cube.png', width: width / 21),
                    ]),
                  ),
                ]),
            SizedBox(
            ...
            Column(
              children: [
                Text(
                  ...
                  style: GoogleFonts.oxygen(
                      fontSize: width * 0.035, color: const Color(0xFFFF40E5)),
                ),
                SizedBox(
                  height: height * 0.01,
                ),
